...
#define LOG_VERBOSE(format, args...)                                     \
    do                                                                   \
    {                                                                    \
        sc_logger::get_logger()->log("VERBOSE", name(), format, ##args); \
    } while (0)
#else
#define LOG_VERBOSE(format, args...)
#endif
...
#define LOG_DEBUG(format, args...)                                     \
    do                                                                 \
    {                                                                  \
        sc_logger::get_logger()->log("DEBUG", name(), format, ##args); \
    } while (0)
#else
#define LOG_DEBUG(format, args...)
#endif
...
#define LOG_INFO(format, args...)                                     \
    do                                                                \
    {                                                                 \
        sc_logger::get_logger()->log("INFO", name(), format, ##args); \
    } while (0)
#else
#define LOG_INFO(format, args...)
#endif
...
#define LOG_ERROR(format, args...)                                     \
    do                                                                 \
    {                                                                  \
        sc_logger::get_logger()->log("ERROR", name(), format, ##args); \
    } while (0)
#else
#define LOG_ERROR(format, args...)
#endif
