...
SCA_TDF_MODULE(sca_tdf_drain)
{
    ...
    void set_attributes() { accept_attribute_changes(); }
...
SC_MODULE(sc_top)
{
  ...
  public:
    SC_CTOR(sc_top)
    {
         ...
         * PWM
         */
        i_pwm = std::make_shared<sc_tlm_pwm>("pwm",
                                             k_pwm_v0,
                                             k_pwm_v1,
                                             sc_core::sc_time(k_pwm_t_period, sc_core::SC_SEC),
                                             sc_core::sc_time(k_pwm_t_ramp, sc_core::SC_SEC));
        i_pwm->pout_pwm->bind(sig_pwm_pout);

        /*
         * ADC module  for the pedal position sensor
         */
        i_adc_pedal_pos = std::make_shared<sc_tlm_adc>("adc_pedal_pos",
                                                       k_adc_app_vref,
                                                       k_adc_app_res,
                                                       k_adc_app_rate,
                                                       sc_core::sc_time(k_tstep_in_sec, sc_core::SC_SEC));
         ...
         */
        i_adc_throttle_pos = std::make_shared<sc_tlm_adc>("adc_throttle_pos",
                                                          k_adc_throttle_vref,
                                                          k_adc_throttle_res,
                                                          k_adc_throttle_rate,
                                                          sc_core::sc_time(k_tstep_in_sec, sc_core::SC_SEC));
