...
SCA_TDF_MODULE(sca_ref_step)
{
  ...
  private:
    void set_attributes() { pout.set_timestep(t_step); }

    void processing() { pout.write(value); }
  ...
  public:
    sca_ref_step(sc_core::sc_module_name nm,
        ...
        : pout("pout"), value(value_), t_step(t_step_)
    {
    }
};
...
SCA_TDF_MODULE(sca_ref_gnd)
{
  public:
    ...
    sca_ref_gnd(sc_core::sc_module_name nm, sca_core::sca_time t_step_ = sca_core::sca_time(0.05, sc_core::SC_MS))
  ...
  private:
    ...
    void processing() { pout_gnd.write(0.0); }
};
