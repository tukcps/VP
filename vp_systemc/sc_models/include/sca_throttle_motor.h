...
SCA_TDF_MODULE(sca_tdf_em_conv)
{
  public:
    ...
    sca_tdf_em_conv(sc_core::sc_module_name nm, double _Km = 0.383, double _Kb = 0.383)
        : pin_i("pin_i"), pin_w("pin_w"), pout_tm("pout_tm"), pout_vb("pout_vb")
    {
        Km = _Km;
        Kb = _Kb;
    }
...
SC_MODULE(sca_eln_dcmotor_e)
{
    ...
    sca_eln_dcmotor_e(sc_core::sc_module_name nm, double _L = 1.5e-3, double _R = 1.5)
        : pin_vs("pin_vs"), pin_vb("pin_vb"), pout_i("pout_i"), n1("n1"), n2("n2"), n3("n3"), n4("n4"), gnd("gnd")
    {
