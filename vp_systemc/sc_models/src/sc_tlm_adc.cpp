...
// ----------------------------------------------------------------------------
sc_tlm_adc::sc_tlm_adc(sc_core::sc_module_name nm, double _vref, int _res, int _rate, sca_core::sca_time _t_step)
    : sc_module(nm), i_bus("bus"), i_adc_ana("adc_ana", _vref, _res, _rate, _t_step)
{
...
// ----------------------------------------------------------------------------
void sc_tlm_adc::bus_read_write(tlm::tlm_generic_payload& trans, sc_core::sc_time& delay)
{
...
//! @brief write bus
// ----------------------------------------------------------------------------
void sc_tlm_adc::bus_write(unsigned char addr, unsigned char wdata)
{
