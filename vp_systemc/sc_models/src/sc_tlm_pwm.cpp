...
sc_tlm_pwm::sc_tlm_pwm(sc_core::sc_module_name nm,
    ...
    : sc_module(nm), i_bus("i_bus"), i_pwm_ana("i_pwm_ana", v0_, v1_, t_period_, t_ramp_)
{
...
// ----------------------------------------------------------------------------
void sc_tlm_pwm::bus_read_write(tlm::tlm_generic_payload& trans, sc_core::sc_time& delay)
{
...
// ----------------------------------------------------------------------------
void sc_tlm_pwm::bus_write(unsigned char addr, unsigned char wdata)
{
